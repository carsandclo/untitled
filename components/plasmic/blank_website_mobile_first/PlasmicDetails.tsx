                  ...
                  {(() => {
                    try {
                      return $ctx.params.slug === "asc"
                        ...
                        ? "Apriwa Motorsport"
                        : $ctx.params.slug === "citadel"
                        ? "Citadel Racing Team"
                        : $ctx.params.slug === "engineplus"
                        ? "Engine Plus Motorsport"
                        : $ctx.params.slug === "jvs"
                        ? "JVS Motorsport"
                        : $ctx.params.slug === "porsche"
                        ? "Porsche Motorsport"
                        : $ctx.params.slug === "rizqy"
                        ? "Rizqy Motorsport"
                        : $ctx.params.slug === "smp"
                        ? "Semen Merah Putih"
                        : $ctx.params.slug === "silo"
                        ? "Silo Maritime Motorsport"
                        : "";
                    } catch (e) {
                      if (
